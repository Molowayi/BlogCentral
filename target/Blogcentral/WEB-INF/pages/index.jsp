    ...
    <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
                ...
                <div class="post-preview">
                    ...
                    <p class="post-meta">Posted by
                        <a href="${pageContext.request.contextPath}/authorPage?author=${blogPostVar.author.userName}">
                            ...
                            <img src="${pageContext.request.contextPath}/image?imageId=${blogPostVar.author.id}" style="width: 20px; height: 20px;"/>
                            </c:if>
                        </a>
                    ...
                    <div class="clearfix">
                        <c:if test="${count!=0 && count+6<fn:length(blogPosts)}">
                            <a class="btn btn-primary float-right"
                               href="search?page&sortType=${sortType}&count=${count+6>=fn:length(blogPosts)?count:count+6}">Next
                                Posts &rarr;</a>
                        </c:if>
                        <c:if test="${count!=0}">
                            <a class="btn btn-primary float-left"
                               href="search?page&sortType=${sortType}&count=${count-6<0?0:count-6}">Previous Posts &larr;</a>
                        </c:if>
            ...
            <div class="clearfix">
                ...
                <c:if test="${count!=0}">
                    <a class="btn btn-primary float-left"
                       href="Central?sortType=${sortType}&count=${count-6<0?0:count-6}">Previous Posts &larr;</a>
                </c:if>
